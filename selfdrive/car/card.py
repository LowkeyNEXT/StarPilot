...
from openpilot.selfdrive.car.ev9_preinit_coordinator import EV9_PANDA_PREINIT_HANDOFF_TIMEOUT_S, EV9PreinitCoordinator
...
class Car(EV9PreinitCoordinator, EV9DashCoordinator):
  ...
  def __init__(self, CI=None, RI=None) -> None:
    ...
    if CI is None:
      ...
      if cached_params is not None and cached_params.carFingerprint == CAR.KIA_EV9:
        ...
        self.CI = get_car(*self.can_callbacks, obd_callback(self.params), alpha_long_allowed, is_release, self.params, num_pandas,
                          cached_params, get_starpilot_toggles())
