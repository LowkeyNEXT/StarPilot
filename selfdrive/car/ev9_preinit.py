...
def load_cached_car_params(params, keys=("CarParamsCache", "CarParamsPersistent", "CarParamsPrevRoute")):
...
def normalize_ev9_cached_starpilot_safety(cached_params, cached_starpilot_params):
  ...
  if len(safety_configs) != 1 or len(starpilot_safety_configs) != 1 or \
      safety_configs[0].safetyModel != car.CarParams.SafetyModel.hyundaiCanfd or \
