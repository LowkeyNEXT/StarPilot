...
def test_model_service_is_scoped_to_ev9():
  ev9 = SimpleNamespace(CP=SimpleNamespace(carFingerprint=CAR.KIA_EV9))
  other = SimpleNamespace(CP=SimpleNamespace(carFingerprint="mock"))

  assert EV9DashCoordinator.dash_extra_services(ev9) == ['modelV2']
  assert EV9DashCoordinator.dash_extra_services(other) == []
