...
VEHICLE_TELEMETRY_SERIAL_ENV = "BOARDD_EV9_VEHICLE_TELEMETRY_SERIAL"
...
def configure_vehicle_telemetry_environment(enabled: bool, internal_serial: str,
  ...
  if selected:
    environ[VEHICLE_TELEMETRY_SERIAL_ENV] = internal_serial
  else:
    environ.pop(VEHICLE_TELEMETRY_SERIAL_ENV, None)
  return selected
