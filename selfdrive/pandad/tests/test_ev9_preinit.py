...
def test_ev9_long_preinit_cereal_status_schema():
  ...
  status.timingValid = True
  status.cycleStartedUs = 100
  status.lastHostTxUs = 200
  ...
  assert status.timingValid
  assert status.cycleStartedUs == 100
  assert status.lastHostTxUs == 200
