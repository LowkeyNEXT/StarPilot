...
# Preserve the original pandad module API while the implementation lives in
# the EV9-owned helper.
EV9_LONG_PREINIT_STATUS_VERSION = ev9_preinit.STATUS_VERSION
EV9_LONG_PREINIT_LEGACY_STATUS_VERSION = ev9_preinit.LEGACY_STATUS_VERSION
EV9_LONG_PREINIT_H7_APP = ev9_preinit.H7_APP
EV9_LONG_PREINIT_FIRMWARE_NAMES = ev9_preinit.FIRMWARE_NAMES
EV9_LONG_PREINIT_SAFETY_PARAM = ev9_preinit.SAFETY_PARAM
EV9_LONG_PREINIT_OPTIONAL_SAFETY_PARAM = ev9_preinit.OPTIONAL_SAFETY_PARAM
EV9_VEHICLE_TELEMETRY_SERIAL_ENV = ev9_preinit.VEHICLE_TELEMETRY_SERIAL_ENV
EV9_PREINIT_STATE_COLLECTING = ev9_preinit.STATE_COLLECTING
EV9_PREINIT_STATE_WAIT_SESSION = ev9_preinit.STATE_WAIT_SESSION
EV9_PREINIT_STATE_WAIT_COMM_CONTROL = ev9_preinit.STATE_WAIT_COMM_CONTROL
EV9_PREINIT_STATE_WAIT_SUPPRESSION = ev9_preinit.STATE_WAIT_SUPPRESSION
EV9_PREINIT_STATE_ACTIVE = ev9_preinit.STATE_ACTIVE
EV9_PREINIT_STATE_HANDOFF = ev9_preinit.STATE_HANDOFF
EV9_PREINIT_STATE_ABORTED = ev9_preinit.STATE_ABORTED
EV9_PREINIT_STATE_RESTORING = ev9_preinit.STATE_RESTORING
EV9_PREINIT_STATE_READY_PENDING_RESPONSE = ev9_preinit.STATE_READY_PENDING_RESPONSE
EV9_PREINIT_FLAG_START_INTENT = ev9_preinit.FLAG_START_INTENT
EV9_PREINIT_FLAG_SUPPRESSION_CONFIRMED = ev9_preinit.FLAG_SUPPRESSION_CONFIRMED
EV9_PREINIT_FLAG_BRIDGE_ACTIVE = ev9_preinit.FLAG_BRIDGE_ACTIVE
EV9_PREINIT_FLAG_HOST_HANDOFF = ev9_preinit.FLAG_HOST_HANDOFF
EV9_PREINIT_FLAG_RESTORE_SENT = ev9_preinit.FLAG_RESTORE_SENT
EV9_PREINIT_IN_FLIGHT_STATES = ev9_preinit.IN_FLIGHT_STATES
EV9_PREINIT_PRESERVE_FLAGS = ev9_preinit.PRESERVE_FLAGS
EV9_LONG_PREINIT_LEGACY_STATUS_STRUCT = ev9_preinit.LEGACY_STATUS_STRUCT
EV9_LONG_PREINIT_STATUS_STRUCT = ev9_preinit.STATUS_STRUCT
EV9_LONG_PREINIT_TIMING_STRUCT = ev9_preinit.TIMING_STRUCT
configure_ev9_vehicle_telemetry_environment = ev9_preinit.configure_vehicle_telemetry_environment
get_ev9_long_preinit_panda = ev9_preinit.enabled_from_params
_get_raw_ev9_long_preinit_status = ev9_preinit._raw_status
get_ev9_long_preinit_status = ev9_preinit.get_status
ev9_long_preinit_status_valid = ev9_preinit.status_valid
ev9_long_preinit_active = ev9_preinit.active
ev9_long_preinit_must_preserve = ev9_preinit.must_preserve
ev9_long_preinit_firmware_selected = ev9_preinit.firmware_selected
ev9_long_preinit_resident_signature = ev9_preinit.resident_signature
ev9_long_preinit_status_snapshot = ev9_preinit.status_snapshot
ev9_long_preinit_status_stable = ev9_preinit.status_stable
ev9_long_preinit_flash_blocked = ev9_preinit.flash_blocked
ev9_long_preinit_reset_blocked = ev9_preinit.reset_blocked
panda_ignition_on = ev9_preinit.ignition_on
...
def main() -> None:
  ...
  while not do_exit:
    ...
    ev9_preinit.configure_vehicle_telemetry_environment(ev9_long_preinit, internal_serial, ev9_preinit_serials)
