...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"CarParamsSafety", {CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION, BYTES}},
    ...
    {"EV9LongPreinitPandaInstalled", {PERSISTENT, BOOL, "0"}},
    {"EV9LongPreinitPandaInstallMarkerMigrated", {PERSISTENT, BOOL, "0"}},
    {"KiaEv9ClusterSideObjectsEnabled", {PERSISTENT, BOOL, "1"}},
    {"KiaEv9ClusterEnhancedBsmEnabled", {PERSISTENT, BOOL, "1"}},
    ...
    {"ObdBleEnabled", {PERSISTENT, BOOL, "0"}},
    {"ObdBleForgetDevicesRequested", {CLEAR_ON_MANAGER_START, BOOL}},
    {"ObdBleName", {PERSISTENT, STRING, "CommaOBD"}},
    {"ObdBlePairingCancelRequested", {CLEAR_ON_MANAGER_START, BOOL}},
    {"ObdBlePairingRequested", {CLEAR_ON_MANAGER_START, BOOL}},
    {"ObdBlePasskey", {CLEAR_ON_MANAGER_START | DONT_LOG, STRING}},
    {"ObdBleStatus", {CLEAR_ON_MANAGER_START | DONT_LOG, JSON, "{}"}},
    ...
    {"PandaSafetyReady", {CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION, BOOL}},
    ...
    {"StarPilotCarParamsSafety", {CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION, BYTES, "", ""}},
