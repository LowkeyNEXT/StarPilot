...
from opendbc.car.hyundai.ev9_preinit import (EV9_COMMUNICATION_CONTROL_REQUEST as EV9_COMMUNICATION_CONTROL_REQUEST,
                                             EV9_COMMUNICATION_CONTROL_RESTORE as EV9_COMMUNICATION_CONTROL_RESTORE,
                                             EV9_OPTIONAL_SAFETY_PARAM as EV9_OPTIONAL_SAFETY_PARAM,
                                             EV9_PANDA_PREINIT_STATUS_VERSION as EV9_PANDA_PREINIT_STATUS_VERSION,
                                             EV9_PRODUCTION_SAFETY_PARAM as EV9_PRODUCTION_SAFETY_PARAM,
                                             EV9PandaPreinitFlags as EV9PandaPreinitFlags,
                                             EV9PandaPreinitHandoff as EV9PandaPreinitHandoff,
                                             EV9PandaPreinitOwner as EV9PandaPreinitOwner,
                                             EV9PandaPreinitState as EV9PandaPreinitState,
                                             _ev9_preinit_statuses as _ev9_preinit_statuses,
                                             attempt_ev9_pre_fingerprint_suppression as attempt_ev9_pre_fingerprint_suppression,
                                             ev9_cached_safety_profile_supported as ev9_cached_safety_profile_supported,
                                             ev9_panda_preinit_armed as ev9_panda_preinit_armed,
                                             ev9_panda_preinit_baselines as ev9_panda_preinit_baselines,
                                             invalidate_ev9_panda_preinit_handoff as invalidate_ev9_panda_preinit_handoff,
                                             update_ev9_panda_preinit_handoff as update_ev9_panda_preinit_handoff)
...
_EV9_MUTABLE_COMPAT_EXPORTS = frozenset(("EV9_EARLY_SUPPRESSION_ACTIVE", "EV9_PANDA_PREINIT_HANDOFF"))


def __getattr__(name: str):
  # These two values are rebound as ownership changes, so proxy live reads
  # instead of exposing stale snapshots from the extracted module.
  if name in _EV9_MUTABLE_COMPAT_EXPORTS:
    return getattr(ev9_preinit, name)
  raise AttributeError(f"module {__name__!r} has no attribute {name!r}")


def __dir__():
  return sorted(set(globals()) | set(_EV9_MUTABLE_COMPAT_EXPORTS))
