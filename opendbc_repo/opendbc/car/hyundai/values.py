...
# Cluster DTE validated on public route segments for these classic CAN EV platforms.
CAN_EV_CLUSTER_DTE_CAR = {
  CAR.HYUNDAI_IONIQ_EV_2020,
  CAR.HYUNDAI_KONA_EV,
  CAR.HYUNDAI_KONA_EV_2022,
}
# Shared energy messages validated on public route segments for these CAN-FD EV platforms.
