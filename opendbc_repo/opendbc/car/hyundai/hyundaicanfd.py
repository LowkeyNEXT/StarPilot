...
# Compatibility surface for helpers moved into ev9_canfd.py. Resolve lazily to
# avoid a circular import while keeping generic Hyundai code free of wrappers.
_EV9_CANFD_COMPAT_EXPORTS = {
  "create_ev9_direct_angle_command": "create_direct_angle_command",
  "create_ev9_inactive_steering_messages": "create_inactive_steering_messages",
  "ccnc_lane_curvature_from_steering_angle": "lane_curvature_from_steering_angle",
  "ev9_scc_control_baseline_available": "scc_control_baseline_available",
  "set_ev9_adrv_baselines": "set_adrv_baselines",
  "create_ev9_adrv_message": "create_adrv_message",
  "_create_ev9_adrv_message_with_signals": "_message_with_signals",
  "create_ev9_acc_control": "create_acc_control",
  "create_ev9_adrv_160": "create_adrv_160",
}


def __getattr__(name: str):
  target = _EV9_CANFD_COMPAT_EXPORTS.get(name)
  if target is not None:
    from opendbc.car.hyundai import ev9_canfd
    return getattr(ev9_canfd, target)
  raise AttributeError(f"module {__name__!r} has no attribute {name!r}")


def __dir__():
  return sorted(set(globals()) | set(_EV9_CANFD_COMPAT_EXPORTS))
